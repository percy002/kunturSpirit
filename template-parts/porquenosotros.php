        ...
        <div class="flex flex-wrap gap-5 justify-center">
            <div class="flex flex-col justify-between py-5 items-center bg-white min-w-[200px] max-w-[300px]"
                ...
                <div class="flex flex-col py-2.5 px-5 items-center gap-1.5">
                    ...
                    <p class="text-center text-sm">Medir la calidad real y detectar defectos en un programa es control
                        de
                        calidad.</p>
            ...
            <div class="flex flex-col justify-between py-5 items-center bg-white min-w-[200px] max-w-[300px]"
                ...
                <div class="flex flex-col py-2.5 px-5 items-center gap-1.5">
                    ...
                    <p class="text-center text-sm">Viaje sin preocupaciones con diseño personalizado y satisfacción
                        garantizada.
                    </p>
            ...
            <div class="flex flex-col justify-between py-5 items-center bg-white min-w-[200px] max-w-[300px]"
                ...
                <div class="flex flex-col py-2.5 px-5 items-center gap-1.5">
                    ...
                    <p class="text-center text-sm">Nos preocupamos por preservar el entorno natural y cultural de Perú
                    </p>
            ...
            <div class="flex flex-col justify-between py-5 items-center bg-white min-w-[200px] max-w-[300px]"
                ...
                <div class="flex flex-col py-2.5 px-5 items-center gap-1.5">
                    ...
                    <p class="text-center text-sm">Viva y cultive en el día a día el espíritu de aventura en el Perú.
                    </p>
